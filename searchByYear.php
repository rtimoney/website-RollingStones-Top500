...
if (isset($_REQUEST['search'])) {
  ...
  $query    = "SELECT album_id, album_name, album_release_year, artist_name FROM album INNER JOIN release_year ON album.album_year = release_year.year_id INNER JOIN artist ON album.album_artist = artist.artist_id WHERE album_release_year LIKE"; //OR user_email=$email
...
if (count($runCheck)===0){
    ...
    echo "<a href='searchByYear.php'>Try Again</a><br><hr>";
...
<form class="form" action="" method="post">
    <h1 class="search">Search for albums released in a particular year : </h1>
    <div id="search">

    <input type="text" class="search-input" name="search" placeholder="Search Year" required />
