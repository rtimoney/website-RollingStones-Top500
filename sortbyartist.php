...
<head>
    <title>500GreatestExploredByArtist</title>
 ...
 <?php
   ...
   $query = "SELECT album.album_ranking, album.album_name, album.album_artwork_link, release_year.album_release_year, artist.artist_name FROM album INNER JOIN release_year ON album.album_year = release_year.year_id INNER JOIN artist ON album.album_artist = artist.artist_id ORDER BY artist.artist_name";
